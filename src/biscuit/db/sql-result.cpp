...
SqlResult::SqlResult(SqlStatus status, const std::any& value) : m_status(status), m_value(value) {}

SqlResult::SqlResult(SqlStatus status, std::any&& value) : m_status(status), m_value(std::move(value)) {}
