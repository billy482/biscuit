	...
	namespace Db {
		...
		class Connection {
			public:
				...
				virtual MetadataId get_metadata(const QByteArray& digest, const QString& hash_algo) = 0;
				...
				virtual MetadataId insert_metadata(const QByteArray& data, const QByteArray& digest, const QString& hash_algo) = 0;
