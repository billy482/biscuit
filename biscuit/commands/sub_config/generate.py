...
def generate_parse(sub_parser: argparse._SubParsersAction) -> None:
	parser = sub_parser.add_parser('generate', aliases=["gen"], help="Generate a default configuration file")
	...
	parser.add_argument('-o', '--output', help="Output file for the generated configuration. If not specified, defaults to 'biscuit.yaml'.", metavar='FILE', default='biscuit.yaml')
