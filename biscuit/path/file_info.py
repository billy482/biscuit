...
class FileInfo:
	def __init__(self, info: Dict[str, Any], parent: Optional['FileInfo'] = None):
	...
	@staticmethod
	def from_stat_result(filename: str, path: str, info: stat_result, parent: Optional['FileInfo'] = None) -> 'FileInfo':
		return FileInfo({
			'filename': filename,
			'path': path,
			'mode': info.st_mode,
